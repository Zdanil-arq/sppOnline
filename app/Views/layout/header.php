    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('dashboard') ?>">
                ...
                <div class="sidebar-brand-text mx-3">Pembayaran SPP Sekolah</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('datasiswa') ?>">Lihat Data Siswa</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('transaksi') ?>">Bayar SPP Siswa</a>
                    </div>
                </div>
            </li>
            ...
            <?php if (session()->role == 'admin'): ?>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('datauser') ?>">
